      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse bg-default" id="navbar_global">
		  ...
		  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
			<a class="dropdown-item" href="farmer/fregister.php">Farmer/User</a>
		  ...
		  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
			<a class="dropdown-item" href="farmer/flogin.php">Farmer/User</a>
        ...
        <div class="container">
          <div class="row row-header">
            <div class="col-12 col-sm-6">
              <h1 class="text-white">Agro weather management system</h1>
              <p class="text-white">
                ...
                <div class="card card-body bg-gradient-success">
                  <blockquote cite="blockquote">
                    <h6 class="mb-0 text-dark">
                      <em><b  id="quote"> “Farming looks mighty easy when your plow is a pencil, and you're a thousand miles from the your field..”</b ></em>
                    </h6>
                    <br />
      ...
      <div class="container ">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
           ...
           <p class=" ">Farmers can get recommendations for crop, fertilizers, and crop produce.</p>
