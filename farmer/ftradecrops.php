    ...
    <thead>
                    ...
                    <tbody>
						...
						<select id="crops" name="crops" class="form-control ">
							...
							<option value="potatoe">Potatoes</option>
							<option value="coffee">Coffee</option>
							<option value="tea">Tea</option>
							<option value="tomatoe">Tomatoes</option>
							<option value="treetomatoe">Tree tomatoe</option>
							<option value="cassava">Cassava</option>
							<option value="yam">Yams</option>
							<option value="redonion">Red Onions</option>
							<option value="avocado">Avocadoes</option>
