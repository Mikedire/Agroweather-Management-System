...
$query5 = "SELECT StateName from state where StCode ='$state'";
    ...
    $updatequery1 = "UPDATE farmerlogin set  farmer_name='$name', email='$email', phone_no='$mobile',  F_gender='$gender',  F_birthday='$dob', F_Location='$city', password='$pass'  where farmer_id='$id'";mysqli_query($conn, $updatequery1);
          ...
          <div class="modal-body bg-gradient-danger">
            ...
            >
			  ...
			  <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input class="form-control" type="email" name="email" value="<?php echo "$para5"?>"/>
                </div>
              </div>
