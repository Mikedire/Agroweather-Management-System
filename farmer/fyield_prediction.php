...
<div class="card text-white bg-gradient-success mb-3">
				  ...
				  <span class=" text-success display-4" > Result  </span>					
					...
					$command = escapeshellcmd("/Users/KIMEU/AppData/Local/Programs/Python/Python38/python.exe ML/yield_prediction/yield_prediction.py $Jstate $Jdistrict $Jseason $Jcrops $Jarea ");
